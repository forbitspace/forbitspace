...
const Network = () => {
  return Network_jsx(Network_BoxSection, null, Network_jsx(Network_WrapContainer, null, Network_jsx(Network_WrapContent, null, Network_jsx(Network_WrapImg, null, Network_jsx(WrapperButtonApp, null, Network_jsx(ButtonBanner, {
    ...
    alt: ""
  }))), " ", Network_jsx(WrapTitle, null, Network_jsx(Network_Title, null, "Multi Network"), Network_jsx(Network_SubText, {
