...
const Leaders = () => {
  return Leader_jsx(Wrapper, null, Leader_jsx(Leader_Title, null, "Our team"), Leader_jsx(WrapperLeader, null, Leader_jsx(Leader, null, Leader_jsx(Leader_StyledMemberItem, null, Leader_jsx(Leader_WrapperIfo, null, Leader_jsx(Leader_FlexItem, null, Leader_jsx(Leader_Name, null, "Baroda Hoang"), Leader_jsx("p", {
    ...
    className: "name"
  }, "Mat Luu"), Leader_jsx("div", {
    className: "content"
  }, "He is a Blockchain Developer for forbitspace. He is an interested coder, and he enjoy using his skills to contribute to the exciting technological advances that happen every day at forbitspace. He graduated from the VNU HCMC-University of Social Sciences and Humanities in 2020 with a bachelor's degree information management. Working here for 2 years, He has accumulated a lot of knowledge and brought great value to the company."))), Leader_jsx(Leader, null, Leader_jsx(Leader_StyledMemberItem, null, Leader_jsx(Leader_WrapperIfo, null, Leader_jsx(Leader_FlexItem, null, Leader_jsx(Leader_Name, null, "Pantinho Vo"), Leader_jsx("p", {
    style: {
      marginLeft: "-13px"
    }
  }, "Manager Blockchain Engineer"), Leader_jsx("p", {
    style: {
      marginLeft: "-13px"
    }
  }, "Engineer"), Leader_jsx("p", null), Leader_jsx(Leader_Social, null, Leader_jsx("a", {
    href: "/",
    target: "_blank",
    rel: "noopener noreferrer"
  }, Leader_jsx("img", {
    ...
    className: "name"
  }, "Pantinho"), Leader_jsx("div", {
    className: "content"
  }, "He is a software engineer who is passionate about everything related to technology, mathematic, and logic. He graduated from the Banking University in 2020 with a bachelor's degree Management Information Systems. He has more than three years of experience working with different fields in technology. Currently, he focus on Blockchain and functional programming at forbitspace.")))), Leader_jsx(WrapperLeader, {
    className: "footer-member"
  }, Leader_jsx(Leader, {
    className: "footer-leader"
  }, Leader_jsx(Leader_StyledMemberItem, null, Leader_jsx(Leader_WrapperIfo, null, Leader_jsx(Leader_FlexItem, null, Leader_jsx(Leader_Name, null, "Joseph Miller"), Leader_jsx("p", {
    style: {
      marginLeft: "-13px"
    }
  }, "CPO"), Leader_jsx("p", null), Leader_jsx(Leader_Social, null, Leader_jsx("a", {
    href: "/",
    target: "_blank",
    rel: "noopener noreferrer"
  }, Leader_jsx("img", {
    ...
    className: "name"
  }, "Joseph Miller"), Leader_jsx("div", {
    className: "content"
  }, "More than 2 years working at  VIETRY CO., LTD", Leader_jsx("br", null), " Frontend Lead at Waytech Ltd", Leader_jsx("br", null), " Back End Developer at CNV Loyalty App Platform")))));
};
