...
const Routing = () => {
  ...
  }), Routing_jsx(Slider, null, Routing_images.map((item, index) => Routing_jsx(Slide, null, Routing_jsx("img", {
...
const Slider = external_styled_components_default.a.div`
    ...
    animation: spin3d linear 50s infinite;
...
const Slide = external_styled_components_default.a.div`
    ...
    :nth-child(1) {
        animation: move1 linear infinite 50s;
    ...
    :nth-child(2) {
        animation: move2 linear infinite 50s;
    ...
    :nth-child(3) {
        animation: move3 linear infinite 50s;
    ...
    :nth-child(4) {
        animation: move4 linear infinite 50s;
    ...
    :nth-child(5) {
        animation: move5 linear infinite 50s;
    ...
    :nth-child(6) {
        animation: move6 linear infinite 50s;
    ...
    :nth-child(7) {
        animation: move7 linear infinite 50s;
    ...
    :nth-child(8) {
        animation: move8 linear infinite 50s;
    ...
    @media (max-width: 1800px){
        &:nth-child(1) { transform: rotateY(   0deg) translateZ(695px); }
        &:nth-child(2) { transform: rotateY(  45deg) translateZ(695px); }
        &:nth-child(3) { transform: rotateY(  90deg) translateZ(695px); }
        &:nth-child(4) { transform: rotateY( 135deg) translateZ(695px); }
        &:nth-child(5) { transform: rotateY( 180deg) translateZ(695px); }
        &:nth-child(6) { transform: rotateY( 225deg) translateZ(695px); }
        &:nth-child(7) { transform: rotateY( 270deg) translateZ(695px); }
        &:nth-child(8) { transform: rotateY( 315deg) translateZ(695px); }
    }
    @media (max-width: 1500px){
        &:nth-child(1) { transform: rotateY(   0deg) translateZ(605px); }
        &:nth-child(2) { transform: rotateY(  45deg) translateZ(605px); }
        &:nth-child(3) { transform: rotateY(  90deg) translateZ(605px); }
        &:nth-child(4) { transform: rotateY( 135deg) translateZ(605px); }
        &:nth-child(5) { transform: rotateY( 180deg) translateZ(605px); }
        &:nth-child(6) { transform: rotateY( 225deg) translateZ(605px); }
        &:nth-child(7) { transform: rotateY( 270deg) translateZ(605px); }
        &:nth-child(8) { transform: rotateY( 315deg) translateZ(605px); }
    }
    @media (max-width: 1375px){
...
var Pramaster_jsx = external_react_default.a.createElement;



const DataPra = [{
  img: "../images/home-page/eth.png"
}, {
  img: "../images/home-page/bsc.png"
}, {
  img: "../images/home-page/polygon.png"
}, {
  img: "../images/home-page/ava.png"
}];

const Pramaster = () => {
  const renderItem = element => {
    return Pramaster_jsx(ItemPra, {
      className: "item-pra"
    }, Pramaster_jsx("img", {
      src: element.img
    }));
  ...
  return Pramaster_jsx(Pramaster_BoxSection, null, Pramaster_jsx(external_reactstrap_["Container"], null, Pramaster_jsx(GroupPra, {
    className: "wrapper-pra"
  }, DataPra.map(item => renderItem(item)))));
};

const Pramaster_BoxSection = external_styled_components_default.a.section`
  position: relative;
  padding: 40px 0;
  margin-bottom: 10vh;
`;
...
function Pramaster_template(i) {
  return `
      &:nth-child(${i + 1}) {
        transform: rotateY(${i * 36}deg) translateZ(500px);
        @media(max-width: 768px) {
          transform: rotateY(${i * 36}deg) translateZ(300px);
        }
        @media(max-width: 576px) {
...
function Pramaster_getAnimations() {
  let str = "";

  for (let index = 0; index < 10; index += 1) {
    str += Pramaster_template(index);
  }

  return str;
}

function Pramaster_animation1(o, a, b, c) {
  let str = `
  0% {
    opacity: ${o};
  }
...
const Network = () => {
  return Network_jsx(Network_BoxSection, null, Network_jsx(Network_WrapContainer, null, Network_jsx(Network_WrapContent, {
    ...
    className: "banner-space"
  }, Network_jsx(components_Routing, null)), Network_jsx("br", null), Network_jsx(Network_SubText, {
    className: "subtext__title"
