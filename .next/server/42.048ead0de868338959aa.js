...
const Leaders = () => {
  return Leader_jsx(Wrapper, null, Leader_jsx(Leader_Title, null, "Our team"), Leader_jsx(WrapperLeader, null, Leader_jsx(Leader, null, Leader_jsx(Leader_StyledMemberItem, null, Leader_jsx(Leader_WrapperIfo, null, Leader_jsx(Leader_FlexItem, null, Leader_jsx(Leader_Name, null, "Baroda Hoang"), Leader_jsx("p", {
    ...
    className: "content"
  }, "He is a software engineer who is passionate about everything related to technology, mathematic, and logic. He has more than years of experience working with different fields in technology. Currently, he focus on Blockchain and functional programming at forbitspace.")))), Leader_jsx(WrapperLeader, {
