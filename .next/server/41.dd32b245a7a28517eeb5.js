...
const ContactUs = () => {
  ...
  const onSubmit = e => {
    e.preventDefault();
    Object(external_emailjs_com_["send"])("SERVICE ID", "TEMPLATE ID", toSend, "User Id").then(response => {
  ...
  return __jsx(BoxSection, null, __jsx(WrapContainer, null, __jsx(Header, null, "Contact Us."), __jsx(WrapperSubmit // action="mailto:ryanspace46@gmail.com"
  , {
    method: "post",
    enctype: "text/plain",
    onSubmit: onSubmit
