...
const Banner = () => {
  ...
  }, __jsx(Text, null, "FBS Token"), __jsx(SubText, null, "Totle aggregates decentralized exchanges and synthetic asset providers into a suite of tools that makes it easy to access deep liquidity for DeFi assets at the best price.")), __jsx(WrapImg, null, __jsx(ImgHalf, null, __jsx("img", {
