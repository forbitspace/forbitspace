...
const Foundation = () => {
  return About_jsx(WrapperBackground, null, About_jsx(WrapContent, null, About_jsx(components_Banner, null), About_jsx(components_RoadMap, null), About_jsx(BackgroundImg, {
