...
const Routing = () => {
  ...
  Object(external_react_["useEffect"])(() => {
    resetTimeout();
    timeoutRef.current = setTimeout(() => setIndex(prevIndex => prevIndex === Routing_images.length - 1 ? 0 : prevIndex + 1), delay);
    return () => {
      resetTimeout();
    };
  }, [index]);
  return Routing_jsx(SlideShow, null, Routing_jsx(Slider, {
    style: {
