...
const Banner = () => {
  return __jsx(BoxSection, null, __jsx(WrapContainer, null, __jsx(WrapImg, null, __jsx(ImgHalf, null, __jsx(external_react_lazyload_default.a, {
    ...
    src: "../gif/gif_aggregation-protocol.gif" // src="https://firebasestorage.googleapis.com/v0/b/image-storage-2f921.appspot.com/o/space-aggregation.gif?alt=media&token=1ace86e6-be8c-4d65-ad75-4717acd316ac"
    ,
...
const Integrate = () => {
  ...
  return Integrate_jsx(Integrate_BoxSection, null, Integrate_jsx(Integrate_WrapContainer, null, Integrate_jsx(Integrate_Content, {
    ...
    alt: "eth-network"
  }))), Integrate_jsx(NetworkOrbit, null, Integrate_jsx(WrapOrbit, null, Integrate_jsx(external_react_lazyload_default.a, {
    height: 200,
    once: true,
    placeholder: Integrate_jsx("img", {
      width: "1251",
      height: "409.79",
    ...
    src: `../gif/gif-network.gif` // src="https://firebasestorage.googleapis.com/v0/b/image-storage-2f921.appspot.com/o/gif-network.gif?alt=media&token=ae8776f4-d207-4aea-9daa-72d0a42aac3a"
    ,
    alt: "gif-eth-orbit"
