...
const LimitOrder = () => {
  return LimitOrder_jsx(WrapperBackground, null, LimitOrder_jsx(WrapContent, null, LimitOrder_jsx(components_Banner, null)), LimitOrder_jsx(Footer["a" /* default */], null));
};
