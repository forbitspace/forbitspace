...
const LimitOrder = () => {
  return AssetsManagement_jsx(WrapperBackground, null, AssetsManagement_jsx(WrapContent, null, AssetsManagement_jsx(components_Banner, null)), AssetsManagement_jsx(Footer["a" /* default */], null));
};
