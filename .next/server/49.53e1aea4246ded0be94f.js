...
const Aggregation = () => {
  return SmartContracts_jsx(WrapperBackground, null, SmartContracts_jsx(WrapContent, null, SmartContracts_jsx(components_Banner, null)), SmartContracts_jsx(Footer["a" /* default */], null));
};
