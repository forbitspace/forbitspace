...
const API = () => {
  return API_jsx(WrapperBackground, null, API_jsx(WrapContent, null, API_jsx(components_Banner, null), API_jsx(components_Swap, null), API_jsx(BackgroundImg, {
