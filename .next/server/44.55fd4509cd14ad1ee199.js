...
const Network = () => {
  return Network_jsx(Network_BoxSection, null, Network_jsx(Network_WrapContainer, null, Network_jsx(Network_WrapContent, {
    ...
    src: "../gif/space_dex_min.gif" // src="https://firebasestorage.googleapis.com/v0/b/image-storage-2f921.appspot.com/o/space_dex.gif?alt=media&token=5631ce05-fb3b-4d8c-825a-f6e1f2db3f00"
    ,
    alt: "space-network"
