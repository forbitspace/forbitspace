...
const Banner = () => {
  ...
  }, Banner_jsx(Title, null, "Contributors"), Banner_jsx(Text, null, "Efficiency in decentralized ", Banner_jsx("br", null), " finance is just forbitswap away"), Banner_jsx(SubText, null, "forbitswap offers the most innovative solutions in de DeFi space, focusing ", Banner_jsx("br", null), " primarily on security, speed and efficiency.")));
};
...
const Index = () => {
  return Contributors_jsx(WrapperBackground, null, Contributors_jsx(Contributors_Container, {
    ...
    title: 'Auditors',
    data: AuditorData
  }), Contributors_jsx(components_Footer, null)));
};
