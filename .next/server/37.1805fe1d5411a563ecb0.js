...
const Integrate = () => {
  ...
  return Integrate_jsx(BoxSection, null, Integrate_jsx(WrapContainer, null, Integrate_jsx(Content, {
  ...
  }, Integrate_jsx(Text, null, "Integrated protocols")), Integrate_jsx(WrapNetwork, null, Integrate_jsx(Network, null, Integrate_jsx(NetworkIcon, {
    className: "eth-gif"
    ...
    alt: "gif-eth-orbit"
  })))), network.map((item, index) => Integrate_jsx(Network, null, Integrate_jsx(NetworkIcon, null, Integrate_jsx(WrapIcon, null, Integrate_jsx("img", {
...
const Banner = /*#__PURE__*/external_react_default.a.lazy(() => __webpack_require__.e(/* import() */ 51).then(__webpack_require__.bind(null, "+Q27")));
const HowItWorks = /*#__PURE__*/external_react_default.a.lazy(() => __webpack_require__.e(/* import() */ 53).then(__webpack_require__.bind(null, "UxSZ")));
const Finder = /*#__PURE__*/external_react_default.a.lazy(() => __webpack_require__.e(/* import() */ 52).then(__webpack_require__.bind(null, "/+/i")));
