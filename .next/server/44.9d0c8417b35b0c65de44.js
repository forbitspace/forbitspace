...
`;
const Assets_Title = external_styled_components_default.a.h2`
  font-size: 1.4rem;
  line-height: 1;
  font-weight: 700;
  @media (max-width: 576px) {
