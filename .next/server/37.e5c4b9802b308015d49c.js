...
const Aggregation = () => {
  return Aggregation_jsx(WrapperBackground, null, Aggregation_jsx(WrapContent, null, Aggregation_jsx(external_react_["Suspense"], {
    fallback: () => {
      return Aggregation_jsx(external_react_default.a.Fragment, null);
    }
  }, Aggregation_jsx(Banner, null)), Aggregation_jsx(components_HowItWorks, null), Aggregation_jsx(components_Finder, null)), Aggregation_jsx(Footer["a" /* default */], null));
};
