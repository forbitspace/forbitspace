...
const Banner = () => {
  ...
  }, __jsx(Title, null, "Aggregation Protocol")), __jsx(WrapImg, null, __jsx(ImgHalf, null, __jsx("img", {
...
const HowItWorks = () => {
  return HowItWorks_jsx(HowItWorks_BoxSection, null, HowItWorks_jsx(HowItWorks_WrapContainer, null, HowItWorks_jsx(HowItWorks_Content, {
    className: "title-banner text-dark text-visi"
  }, HowItWorks_jsx(Text, null, "How it works")), HowItWorks_jsx(HowItWorks_WrapImg, null, HowItWorks_jsx(HowItWorks_ImgHalf, null, HowItWorks_jsx("img", {
...
const Finder = () => {
  return Finder_jsx(Finder_BoxSection, null, Finder_jsx(Finder_WrapContainer, null, Finder_jsx(Finder_Content, {
    ...
    src: "../images/home-page/parfider.png",
    alt: ""
  })))));
};
