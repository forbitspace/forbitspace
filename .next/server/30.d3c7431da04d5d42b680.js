...
const Foundation = () => {
  return Foundation_jsx(WrapperBackground, null, Foundation_jsx(Container, {
    className: "container"
  }, Foundation_jsx(components_Banner, null), Foundation_jsx(Mission, null), Foundation_jsx(components_Grant, null), Foundation_jsx(components_Timeline, null), Foundation_jsx(Footer["a" /* default */], null)));
};
