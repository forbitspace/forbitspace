...
const Introduction = () => {
  return Introduction_jsx(Introduction_BoxSection, null, Introduction_jsx(Introduction_WrapContainer, null, Introduction_jsx(Text, null, Introduction_jsx("p", {
    ...
    className: "forbitspace"
  }, "forbitspace"), " DEX Super Aggregator uses Spaceflight algorithm smart order routing to split a single transaction into multiple orders across various DEXs, also routes orders through allowing crypto traders to tap deep liquidity and receive better pricing, low cost & efficiency in the most of liquidity.")), Introduction_jsx(Introduction_WrapImg, null, Introduction_jsx(external_react_lazyload_default.a, {
    height: 400,
    once: true,
...
const Highlights = () => {
  return Highlights_jsx(Highlights_BoxSection, null, Highlights_jsx(Highlights_WrapContainer, null, Highlights_jsx(Highlights_Text, null, Highlights_jsx("p", {
    ...
    className: "content"
  }, "Our app is built on decentralized crypto for customers to do self-custody of their crypto in the main", " ", Highlights_jsx("span", {
    className: "forbitspace"
  }, "forbitspace"), " app."), Highlights_jsx("p", {
    className: "title"
  }, "\u2022 Space DAO"), Highlights_jsx("p", {
    className: "content"
  }, Highlights_jsx("span", {
    className: "forbitspace"
    ...
    className: "forbitspace"
  }, "forbitswap"), " is a capital-efficient AMM that combines the liquidity on Ethereum blockchain and BNB Chain with the scalability of a Layer 2 platform deployed on the Polygon Network, Avalanche, Arbitrum, and will soon be functional on other blockchains including Solana and more.", Highlights_jsx("br", null), " ", Highlights_jsx("br", null), Highlights_jsx("span", {
    className: "forbitspace"
...
const Allocation = () => {
  return Allocation_jsx(Allocation_BoxSection, null, Allocation_jsx(Allocation_WrapContainer, null, Allocation_jsx(Allocation_Text, null, Allocation_jsx("p", {
    ...
    className: "content"
  }, "\u2022 3,0% Strategic Sale IDO, IEO."), Allocation_jsx("p", {
    className: "content"
  }, "\u2022 5,0% Small backers 5-year vesting."), Allocation_jsx("p", {
    className: "content"
  }, "\u2022 3,0% Advisor with a 5-year vesting."), Allocation_jsx("br", null), Allocation_jsx("br", null), Allocation_jsx("p", {
    className: "content"
...
const Schedules = () => {
  return Schedules_jsx(Schedules_BoxSection, null, Schedules_jsx(Schedules_WrapContainer, null, Schedules_jsx(Schedules_Text, null, Schedules_jsx("p", {
    ...
    className: "forbitspace"
  }, "FBS"), " can also be used for collateral backing or insurance pool staking where stakes can earn interest on their locked tokens."), Schedules_jsx("p", {
    className: "content"
  }, "\u2022", " ", Schedules_jsx("span", {
    className: "title-line"
