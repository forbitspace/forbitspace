...
// CONCATENATED MODULE: ./client/components/ChristmasAnimation/components/Santa.jsx
var Santa_jsx = external_react_default.a.createElement;



const Santa = () => {
  return Santa_jsx(Santa_WrapContent, null, Santa_jsx(Santa_WrapImage, null, Santa_jsx("img", {
    src: "../images/design-image/santa.png",
    alt: "noel-image"
  })));
};

const Santa_shake = external_styled_components_["keyframes"]`
    0% {
...
`;
const run_across_screen = external_styled_components_["keyframes"]`
    0%{
        left: 90%;
        bottom: -10%;
    }
...
`;
const Santa_WrapContent = external_styled_components_default.a.div`
    width: 100%;
    max-width: 240px;
    display: flex;
    flex-wrap: nowrap;
...
`;
const Santa_WrapImage = external_styled_components_default.a.div`
    /* width: 33%; */
    position: fixed;
    ...
    img {
        width: 100%;
        max-width: 280px;
        animation: ${Santa_shake} 20s linear infinite;
    }
    @media (min-width: 1440px) {
        img {
            max-width: 360px;
...
`;
/* harmony default export */ var components_Santa = (Santa);
// CONCATENATED MODULE: ./client/components/ChristmasAnimation/components/Xmas.jsx
var Xmas_jsx = external_react_default.a.createElement;



const Xmas = () => {
  return Xmas_jsx(Xmas_WrapContent, null, Xmas_jsx(WrapOuter, null, Xmas_jsx(Xmas_WrapImage, null, Xmas_jsx("img", {
    src: "../images/design-image/X.png",
    alt: "noel-image"
  })), Xmas_jsx(Xmas_WrapImage, null, Xmas_jsx("img", {
    src: "../images/design-image/M.png",
    alt: "noel-image"
  })), Xmas_jsx(Xmas_WrapImage, null, Xmas_jsx("img", {
    src: "../images/design-image/A.png",
    alt: "noel-image"
  })), Xmas_jsx(Xmas_WrapImage, null, Xmas_jsx("img", {
    src: "../images/design-image/S.png",
    alt: "noel-image"
  }))));
};

const Xmas_shake = external_styled_components_["keyframes"]`
    0% {
        transform: rotate(-20deg);
    }
    25% {
...
`;
const move_form_right = external_styled_components_["keyframes"]`
    0% {
        left: 110%;
    }
    40%{
...
`;
const Xmas_WrapContent = external_styled_components_default.a.div`
    width: 100%;
    /* max-width: 240px; */
    display: flex;
    flex-wrap: nowrap;
...
`;
const WrapOuter = external_styled_components_default.a.div`
    width: fit-content;
    display: flex;
    align-items: flex-end;
    justify-content: center;
...
`;
const Xmas_WrapImage = external_styled_components_default.a.div`
    width: 24%;
...
`;
/* harmony default export */ var components_Xmas = (Xmas);
...
const ChristmasAnimation = () => {
  return ChristmasAnimation_jsx(Wrapper, null, ChristmasAnimation_jsx(ChristmasAnimation_Content, null, ChristmasAnimation_jsx(components_Xmas, null), ChristmasAnimation_jsx(components_Noel, null), ChristmasAnimation_jsx(components_Santa, null)));
};
