...
// CONCATENATED MODULE: ./client/components/Branding/components/Brands.jsx
...
const Brands = () => {
  ...
  return __jsx(BoxSection, null, __jsx(WrapContainer, {
    className: "container"
  }, __jsx(WrapImg, null, __jsx("img", {
    src: "../images/home-page/space-header.png",
    alt: "header-brand-page-image"
  })), __jsx(WrapEmail, null, __jsx(TitleHeader, null, "Brandkit"), __jsx(WrapContentMail, null, __jsx(Text, null, "Say Hello"), __jsx("span", null, "Learn more about forbitspace and see what makes it great."), __jsx("a", {
    href: "mailto:hello@forbitspace.com",
    className: "mail-hello"
  }, "hello@forbitspace.com"), __jsx("span", null, "Please direct inquiries to:", " ", __jsx("a", {
    href: "mailto:press@forbitspace.com"
  }, "press@forbitspace.com")), " ")), __jsx(Content, null, __jsx(Title, null, "forbitspace logo"), __jsx(WrapperLogo, null, forbitspaceLogo.map((item, index) => __jsx(BrandLogo, {
    key: index
  }, __jsx(BackgroundImg, null, __jsx("img", {
    ...
    alt: ""
  })), __jsx(LinkImg, null, __jsx("a", {
    href: `http://localhost:4000/images/brand-logo/brandkit-forbit/forbitspace/SVG/Logo-forbitspace-brandkit-${item.number}.svg`,
    target: "_blank",
    ...
    href: `http://localhost:4000/images/brand-logo/brandkit-forbit/forbitspace/PNG/Logo-forbitspace-brandkit-${item.number}.png`,
    target: "_blank",
    rel: "noopener noreferrer"
  }, __jsx("img", {
    src: "../images/icons/image-regular.svg",
    alt: ""
  }), " ", "png")))))), __jsx(Content, null, __jsx(Title, null, "forbitspace noise logo"), __jsx(WrapperLogo, null, forbitspaceLogoNoise.map((item, index) => __jsx(BrandLogo, {
    key: index
  }, __jsx(BackgroundImg, null, __jsx("img", {
    src: "../images/contributor-page/orbit-background.svg",
    alt: ""
    ...
    href: `http://localhost:4000/images/brand-logo/brandkit-forbit/forbitspace-noise/PNG/Logo-forbitspace-noise-${item.number}.png`,
    target: "_blank",
    rel: "noopener noreferrer"
  }, __jsx("img", {
    src: "../images/icons/image-regular.svg",
    alt: ""
  }), " ", "png")))))), __jsx(Content, null, __jsx(Title, null, "forbitswap logo"), __jsx(WrapperLogo, null, forbitswapLogo.map((item, index) => __jsx(BrandLogo, {
    key: index
  }, __jsx(BackgroundImg, null, __jsx("img", {
    src: "../images/contributor-page/orbit-background.svg",
    alt: ""
  })), __jsx(LogoImg, {
    className: "logo-swap-" + item.number
  }, __jsx("img", {
    src: `../images/brand-logo/brandkit-forbit/forbitswap/PNG/Logo-forbitswap-brandkit-${item.number}.png`,
    alt: ""
  })), __jsx(LinkImg, null, __jsx("a", {
    href: `http://localhost:4000/images/brand-logo/brandkit-forbit/forbitswap/PNG/Logo-forbitswap-brandkit-${item.number}.png`,
    target: "_blank",
    rel: "noopener noreferrer"
  }, __jsx("img", {
    src: "../images/icons/image-regular.svg",
    ...
    href: `http://localhost:4000/images/brand-logo/brandkit-forbit/forbitswap/SVG/Logo-forbitswap-brandkit-${item.number}.svg`,
    target: "_blank",
    rel: "noopener noreferrer"
  }, __jsx("img", {
    src: "../images/icons/image-regular.svg",
    alt: ""
  }), " ", "svg")))))), __jsx(Content, null, __jsx(Title, null, "flyby IDO launchpad logo"), __jsx(WrapperLogo, null, flybyLogo.map((item, index) => __jsx(BrandLogo, {
    key: index
  }, __jsx(BackgroundImg, null, __jsx("img", {
    src: "../images/contributor-page/orbit-background.svg",
    alt: ""
    ...
    href: `http://localhost:4000/images/brand-logo/brandkit-forbit/flyby-IDO/PNG/Flybyido-${item.number}.png`,
    target: "_blank",
    rel: "noopener noreferrer"
  }, __jsx("img", {
    src: "../images/icons/image-regular.svg",
    alt: ""
  }), " ", "png")))))), __jsx(Content, null, __jsx(Title, null, "NFTs space logo"), __jsx(WrapperLogo, null, nftsLogo.map((item, index) => __jsx(BrandLogo, {
    key: index
  }, __jsx(BackgroundImg, null, __jsx("img", {
    src: "../images/contributor-page/orbit-background.svg",
    alt: ""
  })), __jsx(LogoImg, {
    className: "logo-nfts-" + item.number
  }, __jsx("img", {
    ...
    src: "../images/icons/image-regular.svg",
    alt: ""
  }), " ", "png")))))), __jsx(Content, null, __jsx(DownloadButton, null, __jsx(BackgroundImg, null, __jsx("img", {
    src: "../images/contributor-page/orbit-background.svg",
    alt: ""
  })), __jsx("a", {
...
`;
const WrapEmail = external_styled_components_default.a.div`
    width: 100%;
    display: flex;
    align-items: center;
    justify-content: center;
    flex-direction: column;
`;
const WrapContentMail = external_styled_components_default.a.div`
    width: 40%;
    display: flex;
    align-items: center;
    justify-content: center;
...
`;
const TitleHeader = external_styled_components_default.a.div`
    font-size: 36px;
`;
...
const Title = external_styled_components_default.a.div`
    ...
    font-weight: 200;
`;
const WrapperLogo = external_styled_components_default.a.div`
    width: 100%;
    display: flex;
    align-items: center;
    justify-content: center;
...
`;
const BrandLogo = external_styled_components_default.a.div`
    max-width: 450px;
    width: 30%;
...
`;
const LogoImg = external_styled_components_default.a.div`
    width: 55%;
    max-width: 250px;
    position: absolute;
    display: flex;
...
const BackgroundImg = external_styled_components_default.a.div`
    opacity: 0.45;
`;
const LinkImg = external_styled_components_default.a.div`
    position: absolute;
    bottom: 5rem;
    display: flex;
    align-items: center;
...
`;
const DownloadButton = external_styled_components_default.a.div`
    position: relative;
    display: flex;
    align-items: center;
    justify-content: center;
...
`;
/* harmony default export */ var components_Brands = (Brands);
// CONCATENATED MODULE: ./client/components/Branding/index.jsx
var Branding_jsx = external_react_default.a.createElement;
...
const Branding = () => {
  return Branding_jsx(WrapperBackground, {
    className: "container"
  }, Branding_jsx(WrapContent, null, Branding_jsx(components_Brands, null)), Branding_jsx(Footer["a" /* default */], null));
};
...
`;
/* harmony default export */ var components_Branding = __webpack_exports__["default"] = (Branding);
