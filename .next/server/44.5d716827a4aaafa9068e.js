...
const Routing = () => {
  ...
  return Routing_jsx(SlideShow, null, Routing_jsx("img", {
    ...
    style: {
      transform: `translateZ(-180px) rotateY(${idx / Routing_images.length * -360}deg)`,
      transition: idx === 0 ? 'transform 0s' : 'transform 2s'
    }
  }, Routing_images.map((item, index) => Routing_jsx(Slide, {
    key: index,
    style: {
      opacity: `${index === idx % 4 ? "1" : "0"}`
    }
  }, Routing_jsx("img", {
