...
const Planet = () => {
  ...
  return Planet_jsx(Main, null, Planet_jsx(Orbit, null, Planet_jsx(WrapperPlanet, null, Planet_jsx(Circle, null, Planet_jsx(Logo, null, Planet_jsx("img", {
    src: "../images/space-planets/logo.png",
    alt: "logo-forbitspace"
  })), Planet_jsx(RenderSystem, {
    data: DataRender
  }), Planet_jsx(Earth, null, Planet_jsx("img", {
    src: "../images/space-planets/earth.svg",
    alt: "earth-image"
  }), Planet_jsx(Moon, null, Planet_jsx("img", {
...
const Planet_Planet = () => {
  ...
  }, components_Planet_jsx(Planet_Title, null, components_Planet_jsx("img", {
    src: "../images/home-page/forbitspace-word.png",
    alt: "forbitspace-dex-name"
