...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"50":"5d26882ca8e90f4a171e"}[chunkId] + ".js");
...
const DAO = next_dynamic__WEBPACK_IMPORTED_MODULE_1___default()(() => __webpack_require__.e(/* import() */ 50).then(__webpack_require__.bind(null, "ra3j")), {
  ssr: false,
  loadableGenerated: {
