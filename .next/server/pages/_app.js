...
/******/ 			var chunk = require("../" + ({}[chunkId]||chunkId) + "." + {"51":"c23b0e01a87ddd91eae5"}[chunkId] + ".js");
...
const Header = next_dynamic__WEBPACK_IMPORTED_MODULE_3___default()(() => __webpack_require__.e(/* import() */ 51).then(__webpack_require__.bind(null, "dFpG")), {
  ssr: false,
  loadableGenerated: {
