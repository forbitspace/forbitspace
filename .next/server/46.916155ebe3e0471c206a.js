...
const Banner = () => {
  return __jsx(BoxSection, null, __jsx(WrapContainer, null, __jsx(Title, null, "Governance")), __jsx(WrapContainer, null, __jsx(WrapImg, null, __jsx(ImgHalf, null, __jsx("img", {
    src: "../images/home-page/holder.png",
    alt: ""
  }))), __jsx(Content, {
    className: "title-banner text-dark text-visi"
  }, __jsx(WrapText, null, __jsx(SubText, null, __jsx("span", null, "Space Dao Governance"), " consists of the proposition and decision-making process for the different risk parameter changes, improvements and incentives that constitute the policies, and upgrades to governance itself. All future decisions governing the protocol will be enacted through this procedure. The FBS token empowers holders to collectively act as governors of the protocol by enabling them with the capability to vote and propose.")))));
};
...
const SpaceDao = () => {
  return SpaceDao_jsx(WrapperBackground, null, SpaceDao_jsx(WrapContent, null, SpaceDao_jsx(components_Banner, null), SpaceDao_jsx(BackgroundImg, {
    src: "./images/background-line-min.png"
  })), SpaceDao_jsx(Footer["a" /* default */], null));
};
