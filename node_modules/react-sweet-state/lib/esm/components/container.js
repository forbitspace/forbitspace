...
var Container = /*#__PURE__*/function (_Component) {
  ...
  function Container(props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "registry", new StoreRegistry('__local__'));
    ...
    _defineProperty(_assertThisInitialized(_this), "bindContainerActions", function (scope) {
      ...
      _this.scopedHooks = bindActions(hooks, storeState, _this.getContainerProps, actions); // make sure we also reset actionProps
