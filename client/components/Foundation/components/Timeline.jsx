        ...
        <WrapperTimeline>
            <AreaBox>
                ...
                <ContentBox>
                    <Text style={{ display: 'flex' }}>
                        <img src="./images/icon-foundation/network-integrations.svg" alt="" />
                        Network<br />itegrations
                    </Text>
                    <Text>Research and<br />developement</Text>
                    <Text>Education</Text>
            ...
            <ActivityBox>
                ...
                <ContentActivity>
                    ...
                    <Text>
                        A joint liquidity mining program with<br />
                        Wirex offering rewards in 1INCH and WXT
                    </Text>
                </ContentActivity>
            </ActivityBox>
        </WrapperTimeline>
