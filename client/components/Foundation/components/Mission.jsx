    ...
    return (
        <WrapperMission>
            <HeaderContent>
                <Title>Mission</Title>
                <Text>
                    The mission of the forbitspace Foundation is to foster
                    growth and expansion of the forbitspace Network and
                    incentivize contributions through grants and other capital
                    deployment vehicles. The forbitspace Foundation is focused
