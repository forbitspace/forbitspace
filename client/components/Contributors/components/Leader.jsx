        ...
        <Wrapper>
            ...
            <WrapperLeader>
                <Leader>
                    <StyledMemberItem>
                        <WrapperIfo>
                            <FlexItem>
                                ...
                                <p style={{ marginLeft: "-13px" }}>Founder</p>
                    ...
                    <Introduction>
                        ...
                        <div className="content">
                            Before entering the crypto space. He is an expert in
                            marketing and market research. He has been involved
                ...
                <Leader>
                    ...
                    <Introduction>
                        ...
                        <div className="content">
                            He is a financial strategist, fund manager, analyst
                            and currency trader. He has more than 9 years of
                            experience in FINANCIAL MARKET. He also participated
                            in multiple trading and crypto currency events in
                            Dubai, Thailand, Vietnam, Singapore and Hongkong.
                        </div>
                    </Introduction>
                </Leader>
            </WrapperLeader>
            <WrapperLeader>
                ...
                <Leader>
                    ...
                    <Introduction className="vice-leader">
                        <div className="name">Jennie Helen</div>
                        <div className="content">
                            She has always pursued ways to attain her goals with
                            enthusiasm and compassion. She feels she should be
                            working somewhere where she can continue to be
                            creative. She is adaptable to new ideas and
                            technology, and she has the ability to network and
                            build positive relationships. She had previously
                            worked with{" "}
                            <span className="forbitspace">forbitspace</span>,
                            which inspired her to become a blockchain evangelist
                            in order to represent blockchain’s unique capacity
...
const Name = styled.h3`
    font-size: ${({ isAdvisor }) => (isAdvisor ? "18px" : "16px")};
...
const Thumb = styled.div`
    ...
    position: absolute;
    right: ${({ isAdvisor }) => (isAdvisor ? 0 : "0px")};
    ...
    @media (max-width: 576px) {
        ...
        right: ${({ isAdvisor }) => (isAdvisor ? 0 : "-18px")};
