export const FeatureData = [
  {
    title: "No fees",
    content:
      "Unlike legacy protocols, including 0x, the forbitspace Limit Order Protocol charges no fees. This makes the protocol extremely efficient in terms of gas.",
  },
  {
    title: "Dynamic Pricing",
    content:
      "Price calculation is done by smart contracts, based on demand and supply, facilitating the best deals for users. The feature is especially useful for auctions.",
  },
  {
    title: "Conditional orders",
    content:
      "Users can set specific conditions for execution of their orders to maximize earning on trading operations.",
  },
  {
    title: "Extra RFQ support",
    content:
      "The protocol enables the fulfillment of requests for quotations (RFQs) - orders for a specific amount of cryptocurrency to buy or sell.",
  },
  {
    title: "Multichain",
    content:
      "The protocol is operable on Ethereum, Binance Smart Chain and Polygon.",
  },
];
