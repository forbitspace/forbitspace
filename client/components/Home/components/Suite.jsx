      ...
      <Container>
        <div className="groupsuite">
          ...
          <Dreption className="text-dark">
            We build state-of-the-art open-source DeFi applications develop more
            intuitive user interfaces and simplify to access the forbitswap
            protocol and contribute to the world of deventralized finance.
          </Dreption>
          <ListSuite>{DataSuite.map((item) => renderItem(item))}</ListSuite>
        </div>
      </Container>
    </BoxSection>
  );
