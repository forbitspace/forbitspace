        ...
        <BoxSection>
            <WrapContainer>
                ...
                <Content className="title-banner text-dark text-visi">
                    ...
                    <SubText>
                        With <span>forbitspace</span>, the decentralized
                        protocol that empowering traders to provide liquidity to
                        pools and collect extra rewards in{" "}
                        ...
                        <br />
                        <br />
                        Enables you to deposit digital assets into liquidity
